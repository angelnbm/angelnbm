...
![CSS3](https://badgen.net/badge/CSS3/00E599?icon=https://i.postimg.cc/pLHHJVLz/css3.png)
...
![Neon](https://badgen.net/badge/Neon/DB/00E599?icon=https://i.postimg.cc/cLQzxQZY/color.png)
...
Aquí algunos de los proyectos académicos en los que he participado como Programador:

- **📅 Gestión de Horarios para Profesores:** Sistema web desarrollado con **Laravel, PHP y NeonDB**. (Nov 2024)
- **📍 GPS Pasivo:** Implementación de rastreo utilizando **Vue, Javascript y MongoDB**. (Sep 2024)
- **💡 Tablero LED:** Proyecto IoT integrado con interfaz web usando **Vue y MongoDB**. (Oct 2024)
- **🛡️ Monitoreo de Anticopias:** Herramienta de software construida con **HTML, CSS, JS y MongoDB**. (Jun 2024)
